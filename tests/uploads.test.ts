import fs from 'fs';
import type { ResponseLike } from '@snagsolutions/sdk/internal/to-file';
import { toFile } from '@snagsolutions/sdk/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('@snagsolutions/sdk/core/uploads');
    await expect(
