...
```sh
npm install git+ssh://git@github.com:stainless-sdks/snag-solutions-typescript.git
```

> [!NOTE]
> Once this package is [published to npm](https://www.stainless.com/docs/guides/publish), this will become: `npm install @snagsolutions/sdk`
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/snag-solutions-typescript/issues) with questions, bugs, or suggestions.
